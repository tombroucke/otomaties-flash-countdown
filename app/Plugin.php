...
class Plugin
{
    ...
    private function defineAdminHooks()
    {
        ...
        $this->loader->add_action('customize_register', $admin, 'flashMessageInCustomizer');
    }
    ...
    private function defineFrontendHooks()
    {
        ...
        $this->loader->add_filter('body_class', $frontend, 'addBodyClass');

        $this->loader->add_action('flash_message', $frontend, 'flashMessage');
        add_shortcode('flash_message_countdown', [$frontend, 'flashMessageCountdown']);
    }
